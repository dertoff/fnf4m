...
const Toast: React.FC<ToastProps> = ({ message, onClose }) => {
    ...
    return (
        <div 
            className="fixed top-20 sm:top-24 left-1/2 -translate-x-1/2 z-[1000] bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full shadow-lg flex items-center gap-3 animate-slideInDown"
            role="alert"
            aria-live="assertive"
        >
            <InfoIcon />
            ...
            <main className="container mx-auto px-4">
                <section className="mb-8">
                    ...
                    <div className="flex items-center mt-8">
                        <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-full bg-[#E040FB] shadow-[0_0.25rem_0.75rem_0_rgba(224,64,251,0.4)]">
                            <ControllerIcon />
                        </div>
                        <h1 className="ml-4 text-2xl font-bold">Top FNF MODs</h1>
                    </div>
                </section>
